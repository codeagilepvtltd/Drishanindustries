    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Logout()
        {
            ...
            catch (Exception ex)
            {
                ...
                moduleErrorLogRepository.Insert_Modules_Error_Log(PageNames.Login.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name.ToString(), Convert.ToString(sessionManager.IntGlCode), ex.StackTrace, this.GetType().Name.ToString(), ProductCataLog.Web.Common.Common.AppName, ex.Source, "", "", ex.Message);
        ...
        public ActionResult ChangePassword()
        {
            ...
            {
                SQLHelper.writeException(ex);
                moduleErrorLogRepository.Insert_Modules_Error_Log(PageNames.ChangePassword.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name.ToString(), Convert.ToString(sessionManager.IntGlCode), ex.StackTrace, this.GetType().Name.ToString(), ProductCataLog.Web.Common.Common.AppName, ex.Source, "", "", ex.Message);
                return Content(JsonConvert.SerializeObject(0));
            }
        }
