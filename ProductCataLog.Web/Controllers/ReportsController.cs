    ...
    public class ReportsController : Controller
    {
        ...
        public IActionResult GetContactUsList(int fk_LookupType_DetailsId = 0)
        {
            ...
            catch (Exception ex)
            {
                ...
                moduleErrorLogRepository.Insert_Modules_Error_Log(PageNames.ContactUsReport.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name.ToString(), Convert.ToString(sessionManager.IntGlCode), ex.StackTrace, this.GetType().Name.ToString(), ProductCataLog.Web.Common.Common.AppName, ex.Source, "", "", ex.Message);
        ...
        public IActionResult GetProductInquiryListReport(int fk_LookupType_DetailsId = 0)
        {
            ...
            {
                SQLHelper.writeException(ex);
                moduleErrorLogRepository.Insert_Modules_Error_Log(PageNames.ProductInquiryReport.ToString(), System.Reflection.MethodBase.GetCurrentMethod().Name.ToString(), Convert.ToString(sessionManager.IntGlCode), ex.StackTrace, this.GetType().Name.ToString(), ProductCataLog.Web.Common.Common.AppName, ex.Source, "", "", ex.Message);
